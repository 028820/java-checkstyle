...
CONFIG_CHECK_JAR=~/Documents/checkstyle/checkstyle.jar;
CONFIG_CHECK_FILE=~/Documents/checkstyle/checkstyle.xml;
CONFIG_ERROR_FILE=~/Documents/checkstyle/checkstyle_errors.xml;
CONFIG_ERROR_REPORT_FILE=~/Documents/checkstyle/checkstyle_report.xml;
